...
L.control.layers({ Streets: street, Satellite: satellite, Topographic: topo }, {}, { position: "topright" }).addTo(map);
...
function renderRoute() {
  ...
  const polyline = L.polyline(routeLatLngs, { color: "#9d1f22", weight: 4, opacity: 0.95 }).addTo(routeLayer);
